...
(def schema
  {:timelord_user ["user_uuid" "user_key" "username" "password" "first_name" "last_name" "date_created" "time_created"
   ...
   :note_content  ["key" "username" "start_time" "end_time" "total_minutes" "contact" "problem" "remote" "remote_method"
                   "environment" "actions" "next_steps"]
